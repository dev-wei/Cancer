...
var PassportController = function () {
  ...
  self.session = function(req, res) {
    req.user.online = true;
    self.update(req.user);
    res.redirect('/#!/User');
  };
};
PassportController.prototype = Object.create(base.prototype);
PassportController.prototype.constructor = PassportController;
